...
private extension MenuView {
    ...
    func createSubviews() {
        ...
        //navigationBar.backgroundColor = UIColor(red: 25.0/255.0, green: 46/0/255.0, blue: 91.0/255.0, alpha: 1.0)
...
private extension MenuView {
    ...
    func layoutTabs() {
        ...
        /*
        tabs.leadingAnchor.constraint(equalTo: (superview?.leadingAnchor)!).isActive = true
        tabs.topAnchor.constraint(equalTo: (superview?.topAnchor)!).isActive = true
        tabs.trailingAnchor.constraint(equalTo: (superview?.trailingAnchor)!).isActive = true
        */
        ...
        //tabs.topAnchor.constraint(equalTo: topAnchor, constant: 0).isActive = true
    ...
    func layoutScrollMenu() {
        ...
        //scrollMenu.topAnchor.constraint(equalTo: topAnchor, constant: 100.0)
